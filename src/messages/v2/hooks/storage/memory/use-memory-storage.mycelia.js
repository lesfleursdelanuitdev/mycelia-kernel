 ...
 * 
 * Provides in-memory storage functionality to subsystems.
 * Uses MemoryStorageBackend for fast, temporary data storage.
 * 
 ...
 */
import { MemoryStorageBackend } from './memory-storage-backend.mycelia.js';
import { Facet } from '../../../models/facet-manager/facet.mycelia.js';
import { createHook } from '../../create-hook.mycelia.js';
import { getDebugFlag } from '../../../utils/debug-flag.utils.mycelia.js';

export const useMemoryStorage = createHook({
  kind: 'storage',
  version: '1.0.0',
  overwrite: false,
  required: [],
